...
const nextPage = (currentPage, nextPage) => {
    document.querySelector(`.screen3-${currentPage}`).classList.add("escondido");
    document.querySelector(`.screen3-${nextPage}`).classList.remove("escondido");
}
    ...
    for (let i=0; i < numQuestionsRender; i++) {
        ...
        <div onclick="openQuestionForm(this)">
            <section class="question-toggle">
                ...
                <img src="./assets/icon.svg" alt="create-icon" class="create-icon">
            </section>
        </div>
        <div class="question${i+1}-form escondido">
            <form action="" id="question${i+1}" class="escondido">
                <div class="question">
                    <span>Pergunta ${i+1}</span>
...
const openQuestionForm = (element) => {
    ...
    switch (question) {
        case "Pergunta 1":
            document.querySelector(".question1-form").classList.remove("escondido");
            break;
        case "Pergunta 2":
            document.querySelector(".question2-form").classList.remove("escondido");
            break;    
        case "Pergunta 3":
            document.querySelector(".question3-form").classList.remove("escondido");
            break;
        case "Pergunta 4":
            document.querySelector(".question4-form").classList.remove("escondido");
            break;
    }
}
...
const renderLevelConfigSection = () => {
    ...
    for (let i=0; i < numLevelsRender; i++) {
        ...
        <div class="level${i+1}-form escondido">
            <form action="" class="level${i+1} escondido">
                <div class="level">
                    <span>Nível ${i+1}</span>
...
const openLevelForm = (element) => {
    ...
    switch (level) {
        case "Nível 1":
            document.querySelector(".level1-form").classList.remove("escondido");
            break;
        case "Nível 2":
            document.querySelector(".level2-form").classList.remove("escondido");
            break;    
        case "Nível 3":
            document.querySelector(".level3-form").classList.remove("escondido");
            break;
    }
}
